...
<div class="row">
    <div class="col-xl-9 mx-auto">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('data_kampus.update', $dks->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama_kampus') is-invalid @enderror"
                            type="text" name="nama_kampus"
                            value="{{ old('nama_kampus', $dks->nama_kampus) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('fakultas') is-invalid @enderror"
                            ...
                            value="{{ old('fakultas', $dks->fakultas) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('jurusan') is-invalid @enderror"
                            type="text" name="jurusan" value="{{ old('jurusan', $dks->jurusan) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('semester') is-invalid @enderror"
                            type="text" name="semester" value="{{ old('semester', $dks->semester) }}"
