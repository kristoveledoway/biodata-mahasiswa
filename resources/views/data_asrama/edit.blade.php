            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('data_asrama.update', $das->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('nama_asrama') is-invalid @enderror"
                                            ...
                                            value="{{ old('nama_asrama', $das->nama_asrama) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="5"
                                            placeholder="Masukkan Alamat">{{ old('alamat', $das->alamat) }}</textarea>
                                        @error('alamat')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('no_kamar') is-invalid @enderror"
                                            type="text" name="no_kamar"
                                            value="{{ old('no_kamar', $das->no_kamar) }}"
